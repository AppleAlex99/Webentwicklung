        ...
        <div class="col">
            ...
            <form>
                <div class="form-group">
                    ...
                    <br>
                    <label for="beschreibungDerAufgabe">Beschreibung der Aufgabe</label>
                    <textarea class="form-control" rows="5" id="beschreibungDerAufgabe"></textarea>
                    <br>
                    <label for="erstellung">Erstellungsdatum</label>
                    <input type="text" class="form-control" id="erstellung">
                    <br>
                    <label for="faelligBis">Fällig bis</label>
                    <input type="text" class="form-control" id="faelligBis">
                    <br>
                    <label for="zugehReit">Zugehöriger Reiter</label>
                    <input type="text" class="form-control" id="zugehReit">
                    <br>
                    <label for="zustaendig">Zuständig</label>
                    <input type="text" class="form-control" id="zustaendig">
                </div>
